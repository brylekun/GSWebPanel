 ...
 */
?>
<section class="content-header"><h1> Navigation Menu </h1></section>
	...
	echo '<tbody>';
		...
		echo '<tr>';
			...
			echo '<td>';
				...
				echo '</select>';
			echo '</td>';
			echo '<td><input type="text" name="navbar_link" class="form-control" placeholder="usercp/myaccount"/></td>';
			echo '<td><input type="text" name="navbar_phrase" class="form-control" placeholder="My Account"/></td>';
			echo '<td>';
				echo '<select name="navbar_visibility" class="form-control">';
