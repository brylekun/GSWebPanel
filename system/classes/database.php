...
class database {
	...
	function __construct($SQLHOST, $SQLPORT, $SQLDB, $SQLUSER, $SQLPWD, $SQLDRIVER) {
		try {
			...
			if($SQLDRIVER == 3) {
				$this->db = new PDO("odbc:Driver={SQL Server};Server=".$SQLHOST.";Database=".$SQLDB.";charset=UTF-8;Uid=".$SQLUSER.";Pwd=".$SQLPWD.";");
				...
				if($SQLDRIVER == 2) {
					...
					//$this->db = new PDO("dblib:host=".$SQLHOST.":".$SQLPORT.";dbname=".$SQLDB.", ".$SQLUSER,$SQLPWD."");
